...
connect_args={'ssl': {'tls': True}, "client_flag": MULTI_STATEMENTS}
...
def login_method_rawSQL(user_input, user_input_password):
    ...
    query = "SELECT * from students_copy WHERE username = '{0}' and password = '{1}';".format(user_input, user_input_password)
    print(query)
...
user_input_user = "' OR 1=1; DROP TABLE students_copy; -- '"
